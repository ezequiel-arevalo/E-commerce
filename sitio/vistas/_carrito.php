...
<div class="container mt-5">
                    ...
                    <td class="text-center">
                        <div class="input-group flex justify-content-center">
                            <div class="input-group-prepend">
                                <form action="acciones/realizar-compra.php" method="POST" style="display:inline;">
    ...
    <div class="row justify-content-center m-auto mb-5 mt-3">
        <div class="col-auto w-50">
            ...
            <form action="acciones/realizar-compra.php" method="POST" style="display:inline;">
                <button type="submit" name="vaciar_carrito" class="btn btn-danger w-100 p-2">Vaciar Carrito</button>
            </form>
            <form action="acciones/realizar-compra.php" method="POST" style="display:inline;">
                <button type="submit" name="realizar_compra" class="btn btn-success w-100 p-2">Pagar</button>
            </form>
        </div>
    </div>
</div>
