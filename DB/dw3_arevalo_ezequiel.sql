...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 22-07-2023 a las 15:55:13
...
--
ALTER TABLE `productos`
  MODIFY `productos_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=78;
